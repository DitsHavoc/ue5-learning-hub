...
## v3.50.1 — Landscape Guide Home Fix — 9 Sep 2026

- Moved the Landscape Master Guide's authoritative home from Designer Studio to Unreal Learning.
- Added Unreal Learning landing CTA and Designer Studio cross-link instead of duplicating the tutorial.
- Preserved the same tutorial ID and all 78 classroom screenshots.
- Kept the long-form guide out of the short Quick Tutorials library.
- No database migration.
