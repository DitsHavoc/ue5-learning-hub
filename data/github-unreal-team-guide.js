...
(() => {
  ...
  const tutorial = {
    ...
    unrealNextTitle: 'Programmer: build the first mechanic',
    unrealNextText: 'The team pipeline is ready. The Programmer can now build the reusable power system while the Designer blocks out Jam_Main. Keep the ownership rule: Programmer owns the mechanic Blueprints; Designer owns the main level.',
    unrealNextHref: '#/tutorial/power-jam-programmer',
    unrealNextLabel: '⚡ Open the Power Jam Programmer guide →',
