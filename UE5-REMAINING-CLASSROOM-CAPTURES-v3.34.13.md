# UE5 Learning Hub v3.34.13 — Genuine Remaining Classroom Captures
...
- Programming / Quick Tutorial classroom capture groups: **50**.
...
- **Total genuine teacher screenshots: 77**
- Building Block diagrams remain **7** and are not teacher screenshots.

This is down from **80** in v3.34.12, **90** in v3.34.11 and from the original **211**-capture audit.
...
- Line Trace camera/vector maths, Break Hit Result/Hit Actor and Branch recognition now use exact current Epic UE5.8 visuals; Hub-specific distances remain written beside the images.
