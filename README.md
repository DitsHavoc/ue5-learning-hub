# UE5 Learning Hub v3.26.2 — UI Hotfix

## Current release — v3.26.2
...
See `RELEASE-NOTES-v3.26.2.md`, `RELEASE-NOTES-v3.26.0.md`, `RELEASE-NOTES-v3.25.0.md` and `3DS-MAX-CAPTURE-LIST.md` for the UI hotfix, Sculpt Playground and the underlying 3D Modelling Studio teaching design.
