...
function revision(){
  ...
  return `<div class="page-head"><div class="breadcrumb"><a href="#/">Dashboard</a> / Revision</div><span class="eyebrow">RETRIEVAL • JUDGEMENT • RETURN TO THE SOURCE</span><h1>↻ Revision Quizzes</h1><p class="muted">The central revision bank now covers Unreal systems, the Landscape/Sequencer Master Guides, Game Design Theory, Industry & Careers, Designer Studio and 3D Foundations.</p></div>
