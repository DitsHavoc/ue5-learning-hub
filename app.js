...
function programmingPage(){
  ...
  <section class="content-card tutorial-next github-team-home-card"><div><span class="eyebrow">TEAM WORKFLOW • START HERE FOR PAIR PROJECTS</span><h2>🔀 GitHub + Unreal: Two-Person Team Workflow</h2><p>Set up one shared Unreal project across two PCs, learn Clone → Pull → Commit → Push, and avoid binary-asset conflicts by giving each Unreal asset one owner at a time.</p></div><div class="tutorial-next-links"><a class="button primary" href="#/tutorial/github-unreal-team-workflow">Open GitHub team guide →</a></div></section>
...
function route(options={}){
  ...
  else if(parts[0]==='tutorial'&&parts[1]){const t=tutorial(parts[1]);app.innerHTML=tutorialPage(parts[1]);activate(t?.unrealHome?'programming':t?.designModule?'unreal-designer':'tutorials')}
