...
function programmingPage(){
  ...
  <section class="unreal-learning-ladder"><a href="#/blocks"><span>01</span><div><small>3–8 MINUTE MICRO-LEARNING</small><h2>🧱 Building Blocks</h2><p>What does IA, BPI, Struct, AnimBP, NavMesh or Skeletal Mesh actually mean? Learn the term once with a tiny proof exercise.</p><strong>${coreDone}/${coreBlocks.length} Core learned →</strong></div></a><a href="#/path/${n.path}"><span>02</span><div><small>DEEPER SYSTEM UNDERSTANDING</small><h2>⌘ Core System Lessons</h2><p>Understand why systems work, build them carefully, debug them and apply them in a larger mechanic.</p><strong>${completedLessons().length}/${DATA.lessons.length} lessons complete →</strong></div></a><a href="#/tutorials"><span>03</span><div><small>JUST-IN-TIME BUILDING</small><h2>🛠 Quick Tutorials</h2><p>Choose a system family first, then the exact practical outcome. Similar builds are grouped instead of repeated as separate top-level destinations.</p><strong>${(TOOLS.families||[]).length} families • ${TOOLS.tutorials.filter(t=>!t.libraryHidden).length} family builds + ${TOOLS.tutorials.filter(t=>t.libraryHidden&&!t.unrealHome).length} lesson applications →</strong></div></a><a href="#/challenges"><span>04</span><div><small>REMOVE THE TRAINING WHEELS</small><h2>🔥 Challenges & Practice</h2><p>Combine systems without every node being handed to you. This is where copying becomes understanding.</p><strong>Prove it →</strong></div></a></section>
  <section class="snippet-programming-cta integrated"><div><span class="eyebrow">🏔 LANDSCAPE & WORLD BUILDING • UE5.8</span><h2>Build a Landscape from blank terrain to a playable environment.</h2><p>The Landscape Master Guide uses the real classroom screenshots from the full workflow: create, sculpt, smooth, flatten, ramp, materials, Layer Info, paint, foliage, route exclusions, traversal, Edit Layers and Landscape Splines. Once the engine workflow works, use <a href="#/design/landscape">Designer Studio → Landscape, Terrain & Foliage</a> for the design/art decisions.</p></div><a class="button primary" href="#/tutorial/landscape-master-guide">Open Landscape Master Guide →</a></section>
  <section class="snippet-programming-cta integrated"><div><span class="eyebrow">🎬 SEQUENCER & CINEMATICS • UE5.8</span><h2>Build a cinematic from empty Level Sequence to final render.</h2><p>The Sequencer Master Guide covers tracks, keyframes, Cine Cameras, Camera Cuts, lens/focus, interpolation and Movie Render Queue. Then use <a href="#/design/cinematics">Designer Studio → Sequencer & Cutscenes</a> for shot purpose, framing and pacing.</p></div><a class="button primary" href="#/tutorial/sequencer-master-guide">Open Sequencer Master Guide →</a></section>
