...
function modelingPage(){
  ...
  ${modelCritiqueBridge('What reads first, what looks least believable, and what one change would improve this model most?','The studio wall is part of modelling now')}
